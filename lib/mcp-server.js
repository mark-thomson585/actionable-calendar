...
function buildServer() {
  ...
  server.tool(
    "add_item",
    "Add a task or goal to Mark's actionable-calendar. Tasks should have a date (YYYY-MM-DD); goals omit date entirely. For a single time-of-day, set start_time only. For a time range, set both start_time and end_time.",
    {
    ...
    async ({ text, type, date, repeat_rule, start_time, end_time }) => {
